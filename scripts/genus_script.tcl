...
set_db init_hdl_search_path ./sensor_baseline.v
...
read_hdl "sensor_baseline.v"

elaborate legacy_high_power_sensor_node
...
#reports
report_timing > ./report_timing_no_lowpower.rpt
report_power  > ./report_power_no_lowpower.rpt
report_area   > ./report_area_no_lowpower.rpt
report_qor    > ./report_qor_no_lowpower.rpt

 

#Outputs
write_hdl > ./no_lowpower_netlist.v
write_sdc > ./no_lowpower_sdc.sdc
write_sdf -timescale ns -nonegchecks -recrem split -edges check_edge  -setuphold split > outputs1/delays1.sdf
